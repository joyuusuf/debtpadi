    ...
    <aside className="hidden md:flex flex-col w-60 bg-ink-900 border-r border-white/5 min-h-screen fixed left-0 top-0 bottom-0 z-40">
      ...
      <div className="px-6 py-5 border-b border-white/5">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <div className=" h-70 bg-white flex items-center justify-center flex-shrink-0">
            <Image
              src="/debtpadi.png"
              alt="DebtPadi Logo"
              width={80}
      ...
      <div className="px-3 pb-4 border-t border-white/5 pt-4 space-y-1">
        ...
        >
          ...
          Notifications
          <span className="ml-auto text-xs font-bold px-1.5 py-0.5 rounded-full bg-jade/20 text-jade">
            2
          </span>
        </Link>
        ...
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-ink-400 hover:bg-coral-500/10 hover:text-coral-400 transition-all group"
        >
