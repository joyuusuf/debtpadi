...
export const mockDebts: DebtRecord[] = [
  {
    ...
    description: "Bag of rice (50kg) + Semovita x3",
    amount: 45000,
    amountPaid: 12000,
    dueDate: "2024-01-10",
    ...
    status: "overdue",
    payments: [
      { id: "p1", amount: 7000, date: "2023-12-28", note: "Cash payment" },
      { id: "p2", amount: 5000, date: "2024-01-05", note: "Transfer" },
    ],
  },
  {
    id: "d2",
    ...
    description: "Provisions - Noodles, beverages, toiletries",
    amount: 18500,
    amountPaid: 8500,
    dueDate: "2024-02-01",
    ...
    status: "partial",
    payments: [
      { id: "p3", amount: 8500, date: "2024-01-15", note: "Part payment" },
    ],
  },
  {
    id: "d3",
    ...
    description: "Fabric materials - 5 yards ankara",
    amount: 7200,
    amountPaid: 7200,
    dueDate: "2024-01-20",
    ...
    status: "cleared",
    payments: [
      { id: "p4", amount: 3200, date: "2024-01-10", note: "First payment" },
      { id: "p5", amount: 4000, date: "2024-01-18", note: "Final payment" },
    ],
  },
  {
    id: "d4",
    ...
    description: "Wholesale goods - soap, detergent x10 cartons",
    amount: 32000,
    amountPaid: 0,
    dueDate: "2024-01-05",
  ...
  },
  {
    ...
    description: "Pharmaceutical supplies - drugs & OTC",
    amount: 9800,
    amountPaid: 5000,
    dueDate: "2024-02-10",
    ...
    status: "partial",
    payments: [
      { id: "p6", amount: 5000, date: "2024-01-20", note: "Cash" },
    ],
  },
  {
    id: "d6",
    ...
    description: "Electronics - fans x3, kettles x5",
    amount: 55000,
    amountPaid: 20000,
    dueDate: "2023-12-31",
    ...
    status: "overdue",
    payments: [
      { id: "p7", amount: 10000, date: "2023-12-10", note: "Cash" },
      { id: "p8", amount: 10000, date: "2023-12-20", note: "Transfer" },
    ],
  },
];
