    ...
    <>
      ...
      <div className="px-6 py-8 max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            <p className="text-ink-400 text-sm mb-1">Thursday, January 25 · Mama Chioma Stores</p>
            <h1 className="font-heading text-3xl font-bold text-ink-900">Good morning, Chioma</h1>
          </div>
          <Link
            href="/debtors"
