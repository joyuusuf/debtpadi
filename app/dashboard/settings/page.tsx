...
import { User, Bell, Shield, CreditCard, Smartphone, Save, ChevronRight, Upload, Eye } from "lucide-react";
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            {activeTab === "profile" && (
              <div className="bg-white border border-ink-100 rounded-2xl p-4 sm:p-6">
                ...
                <div className="flex flex-col xs:flex-row items-start xs:items-center gap-4 mb-6 sm:mb-8">
                  <div className="relative flex-shrink-0" ref={avatarRef}>
                    ...
                    >
                      {avatarSrc ? (
                        ...
                        <span className="font-heading font-bold text-ink-900 text-xl sm:text-2xl">
                          MC
                        </span>
                      )}
                    </button>
                      ...
                      <div className="absolute top-[calc(100%+8px)] left-0 z-50 bg-white border border-ink-200 rounded-xl overflow-hidden shadow-lg min-w-[176px]">
                        ...
                        <button
                          ...
                          className={`w-full flex items-center gap-2 px-4 py-2.5 text-sm font-medium transition-colors text-left ${
                            avatarSrc
                              ? "text-ink-800 hover:bg-ink-50 cursor-pointer"
                  ...
                  {/* Name & email — static, never changes */}
                  <div>
                    <p className="font-semibold text-ink-800 text-sm sm:text-base">
                      Titilayo Farms &amp; Agro Supplies
                    </p>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 xs:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-ink-600 text-xs sm:text-sm font-medium mb-1.5 sm:mb-2">
                        First name
                      </label>
                      <input
                        defaultValue="Titilayo"
                        className="w-full bg-ink-50 border border-ink-200 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-ink-700 text-sm focus:border-jade/50 focus:ring-2 focus:ring-jade/10 transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-ink-600 text-xs sm:text-sm font-medium mb-1.5 sm:mb-2">
              ...
              <div className="bg-white border border-ink-100 rounded-2xl p-4 sm:p-6">
                ...
                <div className="space-y-1">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center justify-between py-3.5 border-b border-ink-50 last:border-0 gap-4"
                    >
            ...
            {activeTab === "billing" && (
              <div className="space-y-4">
                <div className="bg-white border border-ink-100 rounded-2xl p-4 sm:p-6">
                  <h2 className="font-heading font-bold text-lg sm:text-xl text-ink-900 mb-4">
                    Current Plan
                  </h2>
