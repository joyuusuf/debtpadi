    ...
    <div className="min-h-screen bg-ink-900 flex">
      ...
      <div className="flex-1 flex flex-col items-start justify-left px-6 md:px-12 py-10 min-w-0">
        ...
        <div className="w-full max-w-sm">
          ...
          <form
            className="space-y-5 animate-fade-up [animation-delay:200ms]"
        ...
        <div className="relative z-10 w-full max-w-[300px] text-center">
            ...
            {[
              ...
              <div key={i} className="flex items-start">
                <div className="flex flex-col items-center gap-1.5 w-20">
                  ...
                  <span
                    className={`text-[10px] font-medium leading-tight text-center whitespace-nowrap ${s.done || s.active ? "text-jade" : "text-ink-600"}`}
                  >
                    {s.label}
                  </span>
                </div>
                {i < 2 && (
                  <div
                    className={`w-8 h-px mt-4 flex-shrink-0 ${s.done ? "bg-jade" : "bg-ink-700"}`}
                  />
                )}
              </div>
            ))}
          ...
          <div className="bg-ink-700 border border-white/10 rounded-2xl p-7">
            ...
            <p className="text-ink-400 text-sm leading-relaxed">
              Verifying your email keeps your account secure and ensures you can
              recover it anytime.
            </p>
          </div>
