    ...
    <div className="min-h-screen bg-ink-900 flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-16 py-12">
        ...
        <div className="max-w-sm w-full">
          ...
          <form className="space-y-5 animate-fade-up delay-100" onSubmit={(e) => { e.preventDefault(); window.location.href = '/dashboard'; }}>
            <div>
          ...
          <p className="text-center text-ink-400 text-sm mt-8 animate-fade-up delay-300">
